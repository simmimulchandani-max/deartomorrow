...
const useCases = [
  ["Birthdays", "Save a note, photo, or wish to open on their next birthday."],
  ["Trips", "Capture the little details you never want to forget."],
  ["Weddings", "Collect love notes and memories for the couple to open later."],
  ["Anniversaries", "Revisit the moments that made the year meaningful."],
  ["Future self", "Write something your future-you will need to hear."],
  ["Friend capsules", "Let everyone add memories to one shared time capsule."],
];
  ...
  return (
    <main className="relative min-h-[calc(100vh-9rem)] overflow-hidden bg-[linear-gradient(180deg,_#fff8e5_0%,_#f1e3c6_42%,_#d6ebf5_100%)] px-6 py-12 text-[#4a3c31] sm:py-16">
      ...
      <section className="relative mx-auto w-full max-w-7xl">
        <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1.02fr)_minmax(340px,0.98fr)]">
          <div className="rounded-[2rem] border border-white/60 bg-white/55 px-7 py-10 text-center shadow-[0_30px_120px_rgba(88,110,124,0.16)] backdrop-blur-md sm:px-12 sm:py-12 lg:text-left">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-7 tracking-[0.02em] text-[#6f6259] sm:text-base">
              Save birthday notes, trip reflections, wedding wishes, milestone
              snapshots, or a message to your future self. Until Tomorrow keeps
              it safe until the date you choose.
            </p>

            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/create"
                className="inline-flex min-h-14 items-center justify-center rounded-full border border-[#e7b6a4] bg-[#f7c7b6] px-7 text-sm font-bold uppercase tracking-[0.18em] text-[#4a3c31] shadow-[0_16px_34px_rgba(74,60,49,0.12)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#f4bba8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d79a87] focus-visible:ring-offset-2 focus-visible:ring-offset-white/40 active:translate-y-px"
              >
                Create a Memory
              </Link>
              <Link
                href="/create"
                className="inline-flex min-h-14 items-center justify-center rounded-full border border-white/80 bg-white/65 px-7 text-sm font-bold uppercase tracking-[0.18em] text-[#4a3c31] shadow-sm transition duration-300 hover:-translate-y-0.5 hover:bg-white/85 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d79a87] focus-visible:ring-offset-2 focus-visible:ring-offset-white/40 active:translate-y-px"
              >
                Start a Capsule
              </Link>
            </div>
            ...
            <div className="mt-9 w-full max-w-md lg:max-w-lg">
              {isCheckingSession ? (
                ...
                <div className="rounded-[1.75rem] border border-white/70 bg-white/60 px-5 py-5 shadow-inner">
                  <Link
                    href="/create"
                    className="inline-flex min-h-14 w-full items-center justify-center rounded-full border border-[#e7b6a4] bg-[#f7c7b6] px-7 text-sm font-bold uppercase tracking-[0.18em] text-[#4a3c31] shadow-[0_16px_34px_rgba(74,60,49,0.12)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#f4bba8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d79a87] focus-visible:ring-offset-2 focus-visible:ring-offset-white/40 active:translate-y-px"
                  >
                    Create a Memory
                  </Link>
                </div>
          ...
          >
            <div className="absolute -left-6 top-10 hidden rounded-full border border-white/70 bg-white/50 px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-[#8a786d] shadow-sm backdrop-blur sm:block">
              Future nostalgia
            </div>
            ...
            <div className="rotate-[-1.5deg] rounded-[1.75rem] border border-[#eadfce] bg-[#fffaf2] p-4 shadow-[0_24px_80px_rgba(74,60,49,0.18)] transition duration-500 hover:rotate-0 hover:scale-[1.01]">
              <div className="overflow-hidden rounded-[1.25rem] bg-[linear-gradient(145deg,_#f7c7b6_0%,_#fff2d8_52%,_#d6ebf5_100%)] p-4">
                <div className="relative flex min-h-56 items-end overflow-hidden rounded-[1rem] border border-white/60 bg-[radial-gradient(circle_at_18%_20%,_#fff7d7_0%,_transparent_24%),linear-gradient(145deg,_#f4ad8d_0%,_#f7d9a6_42%,_#8fc6d8_100%)] p-5">
                  ...
                  <div className="absolute bottom-6 left-8 h-10 w-36 rounded-[100%] bg-white/30 blur-md" />
            ...
            <div className="mx-auto mt-5 max-w-sm rounded-full border border-white/70 bg-white/45 px-5 py-3 text-center text-sm leading-6 text-[#5f5147] shadow-sm backdrop-blur">
              A little time capsule for birthdays, trips, weddings, milestones,
              and future-you.
            </div>
          </aside>
        </div>
        ...
        <section className="mt-10 rounded-[2rem] border border-white/65 bg-white/45 p-6 shadow-[0_20px_70px_rgba(88,110,124,0.10)] backdrop-blur sm:p-8">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-bold uppercase tracking-[0.28em] text-[#8a786d]">
              Made for the moments you’ll want to revisit
            </p>
            <h2
              className={`${brandFont.className} mt-3 text-4xl leading-tight text-[#4a3c31] sm:text-5xl`}
            >
